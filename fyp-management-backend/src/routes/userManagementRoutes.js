...
// Download student submission file - Admin only (must come before /:userId)
router.get('/:studentId/submissions/:phase/files/:filename', authenticate, requireRole('Admin'), downloadStudentSubmissionFile);
